...
class OrderStatisticServiceTest {
    ...
    void sendOrderStatisticsMail() {
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2025, 6, 15, 23, 59, 59));
        ...
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2025, 6, 17, 0, 0));
        ...
        // when
        boolean result = orderStatisticService.sendOrderStatisticsMail(
